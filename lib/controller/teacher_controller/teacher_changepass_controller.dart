...
class TeacherChangepassController extends GetxController {
  ...
  Future<void> changePasswordTeacher() async {
    ...
    print(userId);
    if (userId == null) {
      Get.snackbar('Error', 'Teacher ID not found. Please log in again.');
      return;
    }
